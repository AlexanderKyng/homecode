...
import { resolveThemeVariant } from "@openqcode-ai/ui/theme/resolve"
import type { DesktopTheme } from "@openqcode-ai/ui/theme/types"
...
function wireWindowRecovery(win: BrowserWindow, name: string) {
  ...
  win.webContents.on("render-process-gone", (_event, details) => {
    ...
    void show(
      "OpenQCode window terminated unexpectedly",
  ...
  win.on("unresponsive", () => {
    ...
    sampler.start()
    void show("OpenQCode is not responding", "You can relaunch the app, open the logs, or keep waiting.", true)
  })
  win.on("responsive", () => {
