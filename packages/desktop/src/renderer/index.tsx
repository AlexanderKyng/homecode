...
import "./styles.css"
import { useTheme } from "@homecode-ai/ui/theme"
...
const deepLinkEvent = "homecode:deep-link"
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("homecode.global.dat").getItem("language")
