...
import compareVideo from "../../asset/lander/openqcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openqcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openqcode:auth" content={loggedin() ? "true" : "false"} />
