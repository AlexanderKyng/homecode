...
import compareVideo from "../../asset/lander/homecode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/homecode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="homecode:auth" content={loggedin() ? "true" : "false"} />
