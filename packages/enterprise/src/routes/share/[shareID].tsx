import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@homecode-ai/sdk/v2"
import { SessionTurn } from "@homecode-ai/ui/session-turn"
import { SessionReview } from "@homecode-ai/ui/session-review"
import { DataProvider } from "@homecode-ai/ui/context"
import { FileComponentProvider } from "@homecode-ai/ui/context/file"
import { WorkerPoolProvider } from "@homecode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@homecode-ai/ui/logo"
...
import { MessageNav } from "@homecode-ai/ui/message-nav"
import { FileSSR } from "@homecode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@homecode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/homecode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | HomeCode</Title>
              </Show>
              <Meta name="description" content="homecode - The AI coding agent built for the terminal." />
                      ...
                      return (
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            <div class="">
                              <a href="https://github.com/AlexanderKyng/homecode">
                                <Mark />
                              </a>
                            </div>
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/homecode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://github.com/AlexanderKyng/homecode/discussions"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
