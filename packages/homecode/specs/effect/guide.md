...
How we write Effect code in `packages/homecode`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@homecode/Foo") {}
...
Read homecode runtime flags through
