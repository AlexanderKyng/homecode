...
Practical reference for the current tool-migration state in `packages/homecode`.
...
Tool tests should use the existing Effect helpers in `packages/homecode/test/lib/effect.ts`:
