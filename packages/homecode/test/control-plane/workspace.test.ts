  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        process.env.OTEL_RESOURCE_ATTRIBUTES = "service.name=homecode-test"
        ...
        expect(recorded.calls.create[0].env.OTEL_RESOURCE_ATTRIBUTES).toBe("service.name=homecode-test")
