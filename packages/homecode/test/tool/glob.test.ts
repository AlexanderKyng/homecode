  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "homecode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "homecode-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "homecode-glob-reference/repo",
        },
      },
    },
  )
