...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/homecode.git")).toEqual({ owner: "sst", repo: "homecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/homecode")).toEqual({ owner: "sst", repo: "homecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/homecode.git")).toEqual({ owner: "sst", repo: "homecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/homecode")).toEqual({ owner: "sst", repo: "homecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/homecode.git")).toEqual({ owner: "sst", repo: "homecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/homecode")).toEqual({ owner: "sst", repo: "homecode" })
})
