...
describe("homecode read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["mcp", "list"])
        homecode.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["providers", "list"])
        homecode.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["models"])
        homecode.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["agent", "list"])
        homecode.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["session", "list"])
        homecode.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["stats"])
        homecode.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ homecode }) =>
      Effect.gen(function* () {
        const r = yield* homecode.spawn(["db", "path"])
        homecode.expectExit(r, 0, "db path")
