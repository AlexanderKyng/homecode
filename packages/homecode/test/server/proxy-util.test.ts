...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips homecode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-homecode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-homecode-directory")).toBeNull()
      expect(result.get("x-homecode-workspace")).toBeNull()
