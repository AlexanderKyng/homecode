...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips homecode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-homecode-directory"]).toBeUndefined()
      expect(forwarded["x-homecode-workspace"]).toBeUndefined()
