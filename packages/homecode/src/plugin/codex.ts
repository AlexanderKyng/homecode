...
<html>
  <head>
    <title>HomeCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>HomeCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "homecode"
      output.headers["User-Agent"] = `homecode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
