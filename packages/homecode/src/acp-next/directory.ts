...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@homecode/ACPNextDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@homecode/ACPNextDirectory") {}
