...
import type { AssistantMessage as HomeCodeAssistantMessage, Message } from "@homecode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<HomeCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<HomeCodeAssistantMessage, "role"> &
  Partial<Pick<HomeCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@homecode/ACPNextUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@homecode/ACPNextUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@homecode/ACPNextUsage") {}
