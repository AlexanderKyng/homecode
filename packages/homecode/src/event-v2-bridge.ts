...
// homecode and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@homecode-ai/core/account"
import "@homecode-ai/core/catalog"
import "@homecode-ai/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@homecode/EventV2Bridge") {}
