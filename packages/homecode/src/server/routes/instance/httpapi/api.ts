...
export const RootHttpApi = HttpApi.make("homecode-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("homecode-instance")
...
export const HomeCodeHttpApi = HttpApi.make("homecode")
