...
>()("@homecode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@homecode/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-homecode-directory"] || process.cwd()
}
