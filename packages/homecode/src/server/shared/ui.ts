...
export const UI_UPSTREAM = new URL("https://github.com/AlexanderKyng/homecode")
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("homecode-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}
