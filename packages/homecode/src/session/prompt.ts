...
import { AgentAttachment, FileAttachment, ReferenceAttachment, Source } from "@homecode-ai/core/session-prompt"
...
export class Service extends Context.Service<Service, Interface>()("@homecode/SessionPrompt") {}
