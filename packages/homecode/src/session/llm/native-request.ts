import type { JsonSchema, LLMRequest, ProviderMetadata } from "@homecode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@homecode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @homecode-ai/llm request objects from homecode's session/AI SDK-shaped data.
  return LLM.request({
