  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("homecode")
        ? {
            ...(homecodeProjectID ? { "x-homecode-project": homecodeProjectID } : {}),
            "x-homecode-session": input.sessionID,
            "x-homecode-request": input.user.id,
            "x-homecode-client": input.flags.client,
