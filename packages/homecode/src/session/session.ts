import { Slug } from "@homecode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@homecode-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@homecode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".homecode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@homecode/Session") {}
