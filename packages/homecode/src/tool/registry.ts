...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@homecode-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@homecode/ToolRegistry") {}
