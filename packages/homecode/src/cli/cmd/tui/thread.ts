...
import type { GlobalEvent } from "@homecode-ai/sdk/v2"
...
import {
  ...
  ensureRunID,
  sanitizedProcessEnv,
} from "@homecode-ai/core/util/homecode-process"
...
export const TuiThreadCommand = cmd({
  command: "$0 [project]",
  describe: "start homecode tui",
  builder: (yargs) =>
    withNetworkOptions(yargs)
      .positional("project", {
        type: "string",
        describe: "path to start homecode in",
      })
      .option("model", {
        type: "string",
        alias: ["m"],
