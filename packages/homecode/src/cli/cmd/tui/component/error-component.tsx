...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/homecode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("homecode-version", InstallationVersion)
