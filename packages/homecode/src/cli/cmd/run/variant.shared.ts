...
//
// The saved variant persists across sessions in ~/.local/state/homecode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@homecode/RunVariant") {}
