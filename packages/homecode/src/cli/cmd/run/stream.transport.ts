...
import type { Event, GlobalEvent, OpencodeClient } from "@homecode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@homecode/RunStreamTransport") {}
