import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openqcode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
