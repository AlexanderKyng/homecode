...
How we write Effect code in `packages/openqcode`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/Foo") {}
...
Read openqcode runtime flags through
