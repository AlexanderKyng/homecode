...
Practical reference for the current tool-migration state in `packages/openqcode`.
...
Tool tests should use the existing Effect helpers in `packages/openqcode/test/lib/effect.ts`:
