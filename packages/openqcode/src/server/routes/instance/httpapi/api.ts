...
export const RootHttpApi = HttpApi.make("openqcode-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("openqcode-instance")
...
export const OpenQCodeHttpApi = HttpApi.make("openqcode")
