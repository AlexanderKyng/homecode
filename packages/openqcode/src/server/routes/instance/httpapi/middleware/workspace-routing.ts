...
>()("@openqcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openqcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openqcode-directory"] || process.cwd()
}
