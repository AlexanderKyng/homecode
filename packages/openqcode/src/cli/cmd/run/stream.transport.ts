...
import type { Event, GlobalEvent, OpencodeClient } from "@openqcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openqcode/RunStreamTransport") {}
