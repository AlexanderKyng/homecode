...
//
// The saved variant persists across sessions in ~/.local/state/openqcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openqcode/RunVariant") {}
