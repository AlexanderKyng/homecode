...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/openqcode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("openqcode-version", InstallationVersion)
