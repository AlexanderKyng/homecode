...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@openqcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/Project") {}
