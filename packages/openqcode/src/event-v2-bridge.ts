...
// openqcode and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@openqcode-ai/core/account"
import "@openqcode-ai/core/catalog"
import "@openqcode-ai/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@openqcode/EventV2Bridge") {}
