...
import type { AssistantMessage as OpenQCodeAssistantMessage, Message } from "@openqcode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<OpenQCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OpenQCodeAssistantMessage, "role"> &
  Partial<Pick<OpenQCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@openqcode/ACPNextUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@openqcode/ACPNextUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@openqcode/ACPNextUsage") {}
