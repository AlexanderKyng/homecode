...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openqcode/ACPNextDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openqcode/ACPNextDirectory") {}
