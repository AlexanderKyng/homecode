...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@openqcode-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/ToolRegistry") {}
