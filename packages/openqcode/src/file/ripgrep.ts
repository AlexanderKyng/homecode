...
import { sanitizedProcessEnv } from "@openqcode-ai/core/util/openqcode-process"
import { which } from "@/util/which"
import { NonNegativeInt } from "@openqcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".openqcode")) continue
