...
import { lazy } from "@openqcode-ai/core/util/lazy"
...
import { NonNegativeInt, PositiveInt } from "@openqcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/Pty") {}
