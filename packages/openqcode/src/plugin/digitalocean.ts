import type { Hooks, PluginInput } from "@openqcode-ai/plugin"
import type { Model } from "@openqcode-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>OpenQCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to OpenQCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. OpenQCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
