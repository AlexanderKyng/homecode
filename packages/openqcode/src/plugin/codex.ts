...
<html>
  <head>
    <title>OpenQCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>OpenQCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "openqcode"
      output.headers["User-Agent"] = `openqcode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
