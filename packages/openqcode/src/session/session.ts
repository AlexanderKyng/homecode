import { Slug } from "@openqcode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@openqcode-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@openqcode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".openqcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@openqcode/Session") {}
