import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openqcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openqcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @openqcode-ai/llm request objects from openqcode's session/AI SDK-shaped data.
  return LLM.request({
