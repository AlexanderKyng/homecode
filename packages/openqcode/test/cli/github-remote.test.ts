...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openqcode.git")).toEqual({ owner: "sst", repo: "openqcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openqcode")).toEqual({ owner: "sst", repo: "openqcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openqcode.git")).toEqual({ owner: "sst", repo: "openqcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openqcode")).toEqual({ owner: "sst", repo: "openqcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openqcode.git")).toEqual({ owner: "sst", repo: "openqcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openqcode")).toEqual({ owner: "sst", repo: "openqcode" })
})
