  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "openqcode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "openqcode-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "openqcode-glob-reference/repo",
        },
      },
    },
  )
