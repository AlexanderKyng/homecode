...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openqcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-openqcode-directory"]).toBeUndefined()
      expect(forwarded["x-openqcode-workspace"]).toBeUndefined()
