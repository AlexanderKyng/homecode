...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips openqcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-openqcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-openqcode-directory")).toBeNull()
      expect(result.get("x-openqcode-workspace")).toBeNull()
