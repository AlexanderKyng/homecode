...
class Database extends Context.Service<Database, DatabaseShape>()("@homecode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@homecode/example/UserStore") {
