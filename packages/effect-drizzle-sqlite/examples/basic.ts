...
class Database extends Context.Service<Database, DatabaseShape>()("@openqcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@openqcode/example/UserStore") {
