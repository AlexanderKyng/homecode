...
import { ResizeHandle } from "@openqcode-ai/ui/resize-handle"
...
import { Session, type Message } from "@openqcode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@openqcode-ai/ui/toast"
...
import { retry } from "@openqcode-ai/core/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openqcode.ai/desktop-feedback")}
      renderPanel={() =>
