...
import { ResizeHandle } from "@homecode-ai/ui/resize-handle"
...
import { Session, type Message } from "@homecode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@homecode-ai/ui/toast"
...
import { retry } from "@homecode-ai/core/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/AlexanderKyng/homecode/issues")}
      renderPanel={() =>
