export const dict = {
  ...
  "dialog.provider.homecode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.homecode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.homecodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no HomeCode.",
  ...
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.homecodeZen.visit.prefix": "Visite ",
  "provider.connect.homecodeZen.visit.link": "homecode.ai/zen",
  "provider.connect.homecodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no HomeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no HomeCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em homecode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor HomeCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do HomeCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do HomeCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (homecode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: HomeCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "HomeCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor HomeCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do HomeCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o HomeCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o HomeCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o HomeCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o HomeCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do HomeCode.",
