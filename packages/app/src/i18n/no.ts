...
export const dict = {
  ...
  "dialog.provider.homecode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.homecode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.homecodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i HomeCode.",
  ...
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.homecodeZen.visit.prefix": "Besøk ",
  "provider.connect.homecodeZen.visit.link": "homecode.ai/zen",
  "provider.connect.homecodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HomeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HomeCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i homecode.json",
  ...
  "dialog.server.description": "Bytt hvilken HomeCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HomeCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til HomeCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (homecode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HomeCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HomeCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør HomeCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HomeCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HomeCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om HomeCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan HomeCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HomeCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HomeCode.",
