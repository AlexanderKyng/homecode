export const dict = {
  ...
  "dialog.provider.homecode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.homecode.tagline": "Reliable optimized models",
  "dialog.provider.homecodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HomeCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HomeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HomeCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in homecode.json",
  ...
  "dialog.server.description": "Switch which HomeCode server this app connects to.",
  ...
  "toast.update.description": "A new version of HomeCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the HomeCode team",
  ...
  "error.chain.checkConfig": "Check your config (homecode.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "HomeCode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for HomeCode",
  ...
  "settings.general.row.appearance.description": "Customise how HomeCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether HomeCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HomeCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HomeCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HomeCode.",
