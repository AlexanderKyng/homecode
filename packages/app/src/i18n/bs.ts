export const dict = {
  ...
  "dialog.provider.homecode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.homecode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.homecodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u HomeCode-u.",
  ...
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u HomeCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u HomeCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u homecode.json",
  ...
  "dialog.server.description": "Promijeni na koji se HomeCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija HomeCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku HomeCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (homecode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: HomeCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HomeCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni HomeCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u HomeCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako HomeCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li HomeCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu HomeCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se HomeCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju HomeCode-a.",
