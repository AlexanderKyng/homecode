export const dict = {
  ...
  "dialog.provider.openqcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openqcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openqcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenQCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenQCode-u.",
  ...
  "provider.connect.openqcodeZen.line1":
    "OpenQCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openqcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.openqcodeZen.visit.link": "openqcode.ai/zen",
  "provider.connect.openqcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenQCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenQCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openqcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenQCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenQCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenQCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openqcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenQCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenQCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenQCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenQCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenQCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenQCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenQCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenQCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenQCode-a.",
