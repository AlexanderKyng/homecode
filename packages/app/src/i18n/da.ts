export const dict = {
  ...
  "dialog.provider.homecode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.homecode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.homecodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i HomeCode.",
  ...
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.homecodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.homecodeZen.visit.prefix": "Besøg ",
  "provider.connect.homecodeZen.visit.link": "https://github.com/AlexanderKyng/homecode",
  "provider.connect.homecodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i HomeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i HomeCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i homecode.json",
  ...
  "dialog.server.description": "Skift hvilken HomeCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af HomeCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til HomeCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (homecode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, HomeCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "HomeCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør HomeCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for HomeCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan HomeCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om HomeCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan HomeCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når HomeCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af HomeCode.",
