export const dict = {
  ...
  "dialog.provider.openqcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openqcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openqcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenQCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenQCode.",
  ...
  "provider.connect.openqcodeZen.line1":
    "OpenQCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openqcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.openqcodeZen.visit.link": "openqcode.ai/zen",
  "provider.connect.openqcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenQCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenQCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openqcode.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenQCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenQCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenQCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openqcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenQCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenQCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenQCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenQCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenQCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenQCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenQCode.",
