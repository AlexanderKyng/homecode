export const dict = {
  ...
  "dialog.provider.homecode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.homecode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.homecodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez HomeCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w HomeCode.",
  ...
  "provider.connect.homecodeZen.line1":
    "HomeCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.homecodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.homecodeZen.visit.link": "https://github.com/AlexanderKyng/homecode",
  "provider.connect.homecodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w HomeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w HomeCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w homecode.json",
  ...
  "dialog.server.description": "Przełącz serwer HomeCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja HomeCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu HomeCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (homecode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HomeCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HomeCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the HomeCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla HomeCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd HomeCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy HomeCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw HomeCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania HomeCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji HomeCode.",
