import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openqcode-ai/sdk/v2/client"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "openqcode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openqcodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openqcodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openqcodeZen.visit.prefix")}
                <Link href="https://openqcode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.openqcodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.openqcodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
