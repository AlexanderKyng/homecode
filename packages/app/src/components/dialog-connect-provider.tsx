import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@homecode-ai/sdk/v2/client"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "homecode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.homecodeZen.line1")}</div>
