...
import type { MessageV2 } from "openqcode/session/message-v2"
import type { Message } from "openqcode/session/message"
import type { Session } from "openqcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openqcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openqcode_name}>
