---
title: IDE
description: The HomeCode extension for VS Code, Cursor, and other IDEs
---

HomeCode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `homecode` in the terminal to get started.
...
To install HomeCode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `homecode` - the extension installs automatically
...
Search for **HomeCode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `homecode` in the integrated terminal.
