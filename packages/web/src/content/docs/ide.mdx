---
title: IDE
description: The OpenQCode extension for VS Code, Cursor, and other IDEs
---

OpenQCode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `openqcode` in the terminal to get started.
...
To install OpenQCode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `openqcode` - the extension installs automatically
...
Search for **OpenQCode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `openqcode` in the integrated terminal.
