...
สร้าง `.homecode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ HomeCode:
...
- ระดับผู้ใช้ (Global): `~/.config/homecode/commands/`
- ระดับโปรเจ็กต์: `.homecode/commands/`
...
HomeCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
