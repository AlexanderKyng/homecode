...
สร้าง `.openqcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenQCode:
...
- ระดับผู้ใช้ (Global): `~/.config/openqcode/commands/`
- ระดับโปรเจ็กต์: `.openqcode/commands/`
...
OpenQCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
