...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في homecode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في homecode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.homecode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/homecode/tools/`.
