---
title: دعم ACP
description: استخدم OpenQCode في أي محرر متوافق مع ACP.
---

يدعم OpenQCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام OpenQCode عبر ACP، اضبط محررك ليشغّل الأمر `openqcode acp`.

يشغّل هذا الأمر OpenQCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'OpenQCode' من محدد الوكلاء في AI Chat.
...
لاستخدام OpenQCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام OpenQCode كوكيل ACP للدردشة.
...
يعمل OpenQCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات OpenQCode
