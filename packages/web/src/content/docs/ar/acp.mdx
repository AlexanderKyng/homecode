---
title: دعم ACP
description: استخدم HomeCode في أي محرر متوافق مع ACP.
---

يدعم HomeCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام HomeCode عبر ACP، اضبط محررك ليشغّل الأمر `homecode acp`.

يشغّل هذا الأمر HomeCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'HomeCode' من محدد الوكلاء في AI Chat.
...
لاستخدام HomeCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام HomeCode كوكيل ACP للدردشة.
...
يعمل HomeCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات HomeCode
