---
title: خوادم LSP
description: يتكامل OpenQCode مع خوادم LSP لديك.
---

يمكن أن يتكامل OpenQCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي OpenQCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح openqcode لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات openqcode.
