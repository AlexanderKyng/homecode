---
title: خوادم LSP
description: يتكامل HomeCode مع خوادم LSP لديك.
---

يمكن أن يتكامل HomeCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي HomeCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح homecode لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات homecode.
