---
title: Share
description: Share your OpenQCode conversations.
---

OpenQCode's share feature allows you to create public links to your OpenQCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenQCode:
...
OpenQCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenQCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `openqcode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using openqcode in your organization.
