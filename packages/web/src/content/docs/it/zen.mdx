---
title: Zen
description: Lista curata di modelli fornita da OpenQCode.
---
...
OpenQCode Zen è un elenco di modelli testati e verificati forniti dal team di OpenQCode.

Zen funziona come qualsiasi altro provider in OpenQCode. Accedi a OpenQCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenQCode.
:::
...
OpenQCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenQCode Zen funziona come qualsiasi altro provider in OpenQCode.

1. Accedi a **<a href={console}>OpenQCode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenQCode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenQCode
usa il formato `openqcode/<model-id>`. Per esempio, per GPT 5.5, useresti
`openqcode/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su OpenQCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su OpenQCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su OpenQCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenQCode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con OpenQCode.
