---
title: Zen
description: Lista curata di modelli fornita da HomeCode.
---
...
HomeCode Zen è un elenco di modelli testati e verificati forniti dal team di HomeCode.

Zen funziona come qualsiasi altro provider in HomeCode. Accedi a HomeCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con HomeCode.
:::
...
HomeCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

HomeCode Zen funziona come qualsiasi altro provider in HomeCode.

1. Accedi a **<a href={console}>HomeCode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona HomeCode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di HomeCode
usa il formato `homecode/<model-id>`. Per esempio, per GPT 5.5, useresti
`homecode/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su HomeCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su HomeCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su HomeCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato HomeCode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con HomeCode.
