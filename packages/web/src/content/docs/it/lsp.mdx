---
title: Server LSP
description: HomeCode si integra con i tuoi server LSP.
---

HomeCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

HomeCode include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e homecode apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di homecode.
