---
title: Server LSP
description: OpenQCode si integra con i tuoi server LSP.
---

OpenQCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

OpenQCode include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e openqcode apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di openqcode.
