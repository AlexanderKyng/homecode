---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez HomeCode.
---
...
HomeCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół HomeCode.

Zen działa jak każdy inny dostawca w HomeCode. Logujesz się do HomeCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z HomeCode.
:::
...
HomeCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

HomeCode Zen działa jak każdy inny dostawca w HomeCode.

1. Logujesz się do **<a href={console}>HomeCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz HomeCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji HomeCode używa formatu
`homecode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`homecode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w HomeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w HomeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w HomeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w HomeCode także dowolnego innego dostawcy.
