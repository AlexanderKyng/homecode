---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenQCode.
---
...
OpenQCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenQCode.

Zen działa jak każdy inny dostawca w OpenQCode. Logujesz się do OpenQCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OpenQCode.
:::
...
OpenQCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OpenQCode Zen działa jak każdy inny dostawca w OpenQCode.

1. Logujesz się do **<a href={console}>OpenQCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenQCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OpenQCode używa formatu
`openqcode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`openqcode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w OpenQCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w OpenQCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OpenQCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy OpenQCode Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OpenQCode także dowolnego innego dostawcy.
