---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala homecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

homecode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie homecode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI homecode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do homecode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij homecode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `homecode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo HomeCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `homecode.default`.
