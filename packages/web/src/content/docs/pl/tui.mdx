---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openqcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openqcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openqcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openqcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openqcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openqcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `openqcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OpenQCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `openqcode.default`.
