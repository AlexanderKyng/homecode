...
Utwórz `.homecode/commands/test.md`:
...
Możesz zdefiniować polecenia w `homecode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji homecode:
...
- Globalnie: `~/.config/homecode/commands/`
- Na projekt: `.homecode/commands/`
...
homecode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
