...
Utwórz `.openqcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `openqcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openqcode:
...
- Globalnie: `~/.config/openqcode/commands/`
- Na projekt: `.openqcode/commands/`
...
openqcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
