---
title: Zen
description: Kurirana lista modela koje nudi HomeCode.
---
...
HomeCode Zen je lista testiranih i provjerenih modela koje pruža HomeCode tim.

Zen radi kao i svaki drugi provajder u HomeCode. Prijavite se na HomeCode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili HomeCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s HomeCode.
:::
...
HomeCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

HomeCode Zen radi kao i svaki drugi provajder u HomeCode.

1. Prijavite se na **<a href={console}>HomeCode Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite HomeCode Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj HomeCode konfiguraciji koristi format
`homecode/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `homecode/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na HomeCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na HomeCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na HomeCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u HomeCode.
