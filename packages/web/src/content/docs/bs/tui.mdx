---
title: TUI
description: Korištenje korisničkog interfejsa HomeCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HomeCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje HomeCode pokreće TUI za trenutni direktorij.
...
Kada koristite HomeCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u HomeCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz HomeCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `homecode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo HomeCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `homecode.default`.
