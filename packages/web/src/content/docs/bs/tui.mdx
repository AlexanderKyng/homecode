---
title: TUI
description: Korištenje korisničkog interfejsa OpenQCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenQCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenQCode pokreće TUI za trenutni direktorij.
...
Kada koristite OpenQCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenQCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenQCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `openqcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OpenQCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `openqcode.default`.
