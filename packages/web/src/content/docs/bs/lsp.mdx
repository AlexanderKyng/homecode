---
title: LSP serveri
description: OpenQCode se integriše sa vašim LSP serverima.
---

OpenQCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

OpenQCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i openqcode otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj openqcode konfiguraciji.
