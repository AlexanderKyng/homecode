...
Kreiraj `.openqcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenQCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenQCode [config](/docs/config):
...
- Globalno: `~/.config/openqcode/commands/`
- Po projektu: `.openqcode/commands/`
...
OpenQCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
