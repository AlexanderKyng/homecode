...
Kreiraj `.homecode/commands/test.md`:
...
Možete dodati prilagođene komande kroz HomeCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom HomeCode [config](/docs/config):
...
- Globalno: `~/.config/homecode/commands/`
- Po projektu: `.homecode/commands/`
...
HomeCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
