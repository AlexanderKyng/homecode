---
title: ACP podrška
description: Koristite OpenQCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

OpenQCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili OpenQCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `openqcode acp`.

Naredba pokreće OpenQCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "OpenQCode" agenta u AI Chat agent selektoru.
...
Da koristite OpenQCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi OpenQCode kao ACP chat agenta.
...
OpenQCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj OpenQCode konfiguraciji
