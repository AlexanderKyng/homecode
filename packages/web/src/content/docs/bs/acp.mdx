---
title: ACP podrška
description: Koristite HomeCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

HomeCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili HomeCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `homecode acp`.

Naredba pokreće HomeCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "HomeCode" agenta u AI Chat agent selektoru.
...
Da koristite HomeCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi HomeCode kao ACP chat agenta.
...
HomeCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj HomeCode konfiguraciji
