---
title: Özel Araçlar
description: LLM'un homecode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. homecode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.homecode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/homecode/tools/` içine yerleştirerek.
