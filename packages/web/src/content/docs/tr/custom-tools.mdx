---
title: Özel Araçlar
description: LLM'un openqcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openqcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openqcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openqcode/tools/` içine yerleştirerek.
