...
Ajan becerileri, homecode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
homecode su konumlari tarar:

- Proje konfigurasyonu: `.homecode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/homecode/skills/<name>/SKILL.md`
...
Proje yerel yollarinda homecode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.homecode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/homecode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.homecode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
homecode, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`homecode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`homecode.json` icinde):
