---
title: Paylasim
description: openqcode konusmalarini genel baglantilarla paylasin.
---

openqcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openqcode:
...
openqcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openqcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openqcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openqcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
