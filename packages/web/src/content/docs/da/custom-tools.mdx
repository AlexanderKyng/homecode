...
description: Opret værktøjer, som LLM kan kalde homecode ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med homecodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.homecode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/homecode/tools/`.
