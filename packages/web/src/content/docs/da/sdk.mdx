...
Brug den til at bygge integrasjoner og kontrollere homecode programmatisk.
...
Opret en forekomst av homecode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `homecode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av homecode, kan du oprete en klientforekomst for at koble til den:
