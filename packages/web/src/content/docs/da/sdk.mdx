...
Brug den til at bygge integrasjoner og kontrollere openqcode programmatisk.
...
Opret en forekomst av openqcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openqcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openqcode, kan du oprete en klientforekomst for at koble til den:
