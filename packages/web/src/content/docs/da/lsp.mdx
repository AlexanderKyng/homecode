---
title: LSP-servere
description: OpenQCode integreres med dine LSP-servere.
---

OpenQCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenQCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og openqcode åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openqcode-konfiguration.
