---
title: LSP-servere
description: HomeCode integreres med dine LSP-servere.
---

HomeCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

HomeCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og homecode åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din homecode-konfiguration.
