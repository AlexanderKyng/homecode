...
Her er alle de innebygde verktøyene som er tilgængelige i OpenQCode.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenQCode-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
