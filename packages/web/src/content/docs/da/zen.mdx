---
title: Zen
description: Udvalgt liste over modeller leveret af HomeCode.
---
...
HomeCode Zen er en liste over testede og verificerede modeller leveret af HomeCode-teamet.

Zen fungerer som enhver anden udbyder i HomeCode. Du logger ind på HomeCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med HomeCode.
:::
...
HomeCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

HomeCode Zen fungerer som enhver anden udbyder i HomeCode.

1. Du logger ind på **<a href={console}>HomeCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger HomeCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din HomeCode-konfiguration
bruger formatet `homecode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `homecode/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på HomeCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på HomeCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på HomeCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med HomeCode også.
