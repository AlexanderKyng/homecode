---
title: Zen
description: Udvalgt liste over modeller leveret af OpenQCode.
---
...
OpenQCode Zen er en liste over testede og verificerede modeller leveret af OpenQCode-teamet.

Zen fungerer som enhver anden udbyder i OpenQCode. Du logger ind på OpenQCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med OpenQCode.
:::
...
OpenQCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OpenQCode Zen fungerer som enhver anden udbyder i OpenQCode.

1. Du logger ind på **<a href={console}>OpenQCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger OpenQCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din OpenQCode-konfiguration
bruger formatet `openqcode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `openqcode/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på OpenQCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på OpenQCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på OpenQCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte OpenQCode Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med OpenQCode også.
