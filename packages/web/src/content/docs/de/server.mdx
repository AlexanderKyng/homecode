---
title: Server
description: Nutze den openqcode-Server ueber HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Der Befehl `openqcode serve` startet einen headless HTTP-Server.
Er stellt einen OpenAPI-Endpunkt bereit, den ein openqcode-Client nutzen kann.
...
Der Benutzername ist standardmaessig `openqcode`, kann aber mit `OPENCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `openqcode serve` und `openqcode web`.
...
Wenn du `openqcode` startest, werden TUI und Server gestartet.
...
:::tip
Nutze den openqcode-Server, um openqcode programmatisch anzusteuern.
:::

Diese Architektur erlaubt mehrere Clients und programmatische Nutzung.

Mit `openqcode serve` startest du einen eigenstaendigen Server.
Laeuft bereits eine TUI, startet `openqcode serve` trotzdem eine neue Serverinstanz.
...
Dieses Muster nutzen auch die OpenQCode-[IDE](/docs/ide)-Plugins.
...
Der openqcode-Server stellt folgende APIs bereit.
