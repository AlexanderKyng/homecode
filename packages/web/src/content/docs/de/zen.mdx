---
title: Zen
description: Kuratierte Modellliste direkt von HomeCode.
---
...
HomeCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom HomeCode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in HomeCode. Du meldest dich bei HomeCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um HomeCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit HomeCode funktionieren.
:::
...
HomeCode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

HomeCode Zen funktioniert wie jeder andere Provider in HomeCode.

1. Du meldest dich bei **<a href={console}>HomeCode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst HomeCode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner HomeCode-Konfiguration verwendet das Format `homecode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `homecode/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf HomeCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf HomeCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf HomeCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben HomeCode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit HomeCode auch jeden anderen Provider zu verwenden.
