---
title: Zen
description: Kuratierte Modellliste direkt von OpenQCode.
---
...
OpenQCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom OpenQCode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in OpenQCode. Du meldest dich bei OpenQCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um OpenQCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit OpenQCode funktionieren.
:::
...
OpenQCode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

OpenQCode Zen funktioniert wie jeder andere Provider in OpenQCode.

1. Du meldest dich bei **<a href={console}>OpenQCode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst OpenQCode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenQCode-Konfiguration verwendet das Format `openqcode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `openqcode/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf OpenQCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf OpenQCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf OpenQCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OpenQCode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit OpenQCode auch jeden anderen Provider zu verwenden.
