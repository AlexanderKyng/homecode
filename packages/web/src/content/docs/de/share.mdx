---
title: Teilen
description: Teile OpenQCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenQCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenQCode Folgendes:
...
OpenQCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenQCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openqcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openqcode in deiner Organisation einsetzt.
