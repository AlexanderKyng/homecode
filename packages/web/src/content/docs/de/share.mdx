---
title: Teilen
description: Teile HomeCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu HomeCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht HomeCode Folgendes:
...
HomeCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt HomeCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`homecode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du homecode in deiner Organisation einsetzt.
