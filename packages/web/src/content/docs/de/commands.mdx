...
Erstellen Sie `.homecode/commands/test.md`:

```md title=".homecode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die HomeCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem HomeCode [config](/docs/config):

```json title="homecode.jsonc" {4-12}
{
...
- Global: `~/.config/homecode/commands/`
- Pro Projekt: `.homecode/commands/`

```markdown title="~/.config/homecode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".homecode/commands/component.md"
---
...
```md title=".homecode/commands/create-file.md"
---
...
```md title=".homecode/commands/analyze-coverage.md"
---
...
```md title=".homecode/commands/review-changes.md"
---
...
```md title=".homecode/commands/review-component.md"
---
...
HomeCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
