---
title: LSP Server
description: OpenQCode lässt sich in Ihren LSP-Server integrieren.
---

OpenQCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

OpenQCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und OpenQCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer OpenQCode-Konfiguration aktivieren und anpassen.
