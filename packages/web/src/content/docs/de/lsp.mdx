---
title: LSP Server
description: HomeCode lässt sich in Ihren LSP-Server integrieren.
---

HomeCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

HomeCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und HomeCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer HomeCode-Konfiguration aktivieren und anpassen.
