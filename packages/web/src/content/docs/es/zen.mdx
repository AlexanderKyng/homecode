---
title: Zen
description: Lista seleccionada de modelos proporcionada por OpenQCode.
---
...
OpenQCode Zen es una lista de modelos probados y verificados proporcionada por el equipo de OpenQCode.

Zen funciona como cualquier otro proveedor en OpenQCode. Inicias sesión en OpenQCode Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con OpenQCode.
:::
...
OpenQCode Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

OpenQCode Zen funciona como cualquier otro proveedor en OpenQCode.

1. Inicias sesión en **<a href={console}>OpenQCode Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas OpenQCode Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de OpenQCode
usa el formato `openqcode/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`openqcode/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en OpenQCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en OpenQCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en OpenQCode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con OpenQCode.
