...
Crear `.homecode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración HomeCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su HomeCode [config](/docs/config):
...
- Por proyecto: `.homecode/commands/`
...
homecode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
