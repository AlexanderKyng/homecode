...
Crear `.openqcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenQCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenQCode [config](/docs/config):
...
- Por proyecto: `.openqcode/commands/`
...
openqcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
