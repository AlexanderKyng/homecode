---
title: TUI
description: Usando la interfaz de usuario del terminal OpenQCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenQCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenQCode se inicia TUI para el directorio actual.
...
Cuando utilice OpenQCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenQCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenQCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `openqcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera OpenQCode después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `openqcode.default`.
