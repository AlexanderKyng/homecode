---
title: Zen
description: Lista selecionada de modelos fornecidos pelo OpenQCode.
---
...
O OpenQCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do OpenQCode.

O Zen funciona como qualquer outro provedor no OpenQCode. Você faz login no OpenQCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o OpenQCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o OpenQCode.
:::
...
O OpenQCode Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O OpenQCode Zen funciona como qualquer outro provedor no OpenQCode.

1. Você faz login no **<a href={console}>OpenQCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona OpenQCode Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do OpenQCode usa o formato `openqcode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `openqcode/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no OpenQCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no OpenQCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no OpenQCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o OpenQCode também.
