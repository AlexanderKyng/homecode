---
title: LSP Servers
description: HomeCode integrates with your LSP servers.
---

HomeCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

HomeCode comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and homecode opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your homecode config.
