...
Opprett `.openqcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenQCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenQCode [config](/docs/config):
...
- Per prosjekt: `.openqcode/commands/`
...
OpenQCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
