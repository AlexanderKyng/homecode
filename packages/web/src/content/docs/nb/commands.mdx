...
Opprett `.homecode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom HomeCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i HomeCode [config](/docs/config):
...
- Per prosjekt: `.homecode/commands/`
...
HomeCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
