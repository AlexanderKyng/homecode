---
title: Zen
description: Utvalgt liste over modeller levert av OpenQCode.
---
...
OpenQCode Zen er en liste over testede og verifiserte modeller levert av OpenQCode-teamet.

Zen fungerer som enhver annen leverandør i OpenQCode. Du logger inn på OpenQCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OpenQCode.
:::
...
OpenQCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OpenQCode Zen fungerer som enhver annen leverandør i OpenQCode.

1. Du logger inn på **<a href={console}>OpenQCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger OpenQCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i OpenQCode-konfigurasjonen din
bruker formatet `openqcode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `openqcode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på OpenQCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på OpenQCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OpenQCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet OpenQCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med OpenQCode også.
