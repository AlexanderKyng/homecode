---
title: Zen
description: Utvalgt liste over modeller levert av HomeCode.
---
...
HomeCode Zen er en liste over testede og verifiserte modeller levert av HomeCode-teamet.

Zen fungerer som enhver annen leverandør i HomeCode. Du logger inn på HomeCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med HomeCode.
:::
...
HomeCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

HomeCode Zen fungerer som enhver annen leverandør i HomeCode.

1. Du logger inn på **<a href={console}>HomeCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger HomeCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i HomeCode-konfigurasjonen din
bruker formatet `homecode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `homecode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på HomeCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på HomeCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på HomeCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet HomeCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med HomeCode også.
