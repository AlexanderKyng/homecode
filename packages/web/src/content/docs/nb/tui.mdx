---
title: TUI
description: Bruke homecode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HomeCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre HomeCode starter TUI for gjeldende katalog.
...
Når du bruker HomeCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til HomeCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt HomeCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `homecode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge HomeCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `homecode.default`.
