---
title: TUI
description: Bruke openqcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenQCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenQCode starter TUI for gjeldende katalog.
...
Når du bruker OpenQCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenQCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenQCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `openqcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge OpenQCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `openqcode.default`.
