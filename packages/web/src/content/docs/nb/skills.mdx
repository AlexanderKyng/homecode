...
Agentferdigheter lar HomeCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går homecode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
homecode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `homecode.json`:
