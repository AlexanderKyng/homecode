...
Agentferdigheter lar OpenQCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går openqcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
openqcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `openqcode.json`:
