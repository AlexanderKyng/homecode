---
title: LSP-servere
description: openqcode integreres med LSP-serverne dine.
---

OpenQCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenQCode kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og openqcode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenQCode-konfigurasjonen.
