---
title: LSP-servere
description: homecode integreres med LSP-serverne dine.
---

HomeCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

HomeCode kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og homecode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i HomeCode-konfigurasjonen.
